...
class MEMO
{
	public:
		...
		void evaluates_sol(int toSolve[], float *ob1, float *ob2, float *ob3)
		{
			mod = new MULTIPCTBP();			

			mod->call_model(destinations, flights, flightData, tripSearch, tl, depot, gammaVal, norm, toSolve, ob1, ob2, ob3);
		}
